...
/** Complex numbers of big floating rationals. */
...
/** Multiplies this number by [multiplicand]. */
public operator fun BFloating.times(multiplicand: BComplex): BComplex =
    multiplicand * this

/** Multiplies this number by [multiplicand]. */
public operator fun BComplex.times(multiplicand: BFloating): BComplex =
    this * (multiplicand + BRat.ZERO.i)

/** Multiplies this number by [multiplicand]. */
public operator fun Double.times(multiplicand: BComplex): BComplex =
    multiplicand * this

/** Multiplies this number by [multiplicand]. */
public operator fun BComplex.times(multiplicand: Double): BComplex =
    this * (multiplicand + BRat.ZERO.i)

/** Multiplies this number by [multiplicand]. */
public operator fun Float.times(multiplicand: BComplex): BComplex =
    multiplicand * this

/** Multiplies this number by [multiplicand]. */
public operator fun BComplex.times(multiplicand: Float): BComplex =
    this * (multiplicand + BRat.ZERO.i)
