...
public operator fun BRat.plus(imag: BImag): BComplex =
    BComplex(this, imag)

public operator fun BImag.plus(real: BRat): BComplex = real + this

public operator fun BFixed.plus(imag: BImag): BComplex =
    toBigRational() + imag

public operator fun BImag.plus(real: BFixed): BComplex = real + this

public operator fun Long.plus(imag: BImag): BComplex =
    toBigRational() + imag

public operator fun BImag.plus(real: Long): BComplex = real + this

public operator fun Int.plus(imag: BImag): BComplex =
    toBigRational() + imag
...
public operator fun BImag.minus(real: BFixed): BComplex =
    -real + this

public operator fun BFixed.minus(imag: BImag): BComplex =
    this + -imag
